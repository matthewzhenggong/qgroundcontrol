...
#ifndef ZTFirmwarePlugin_H
#define ZTFirmwarePlugin_H

#include "FirmwarePlugin.h"
#include "ParameterManager.h"
#include "ZTParameterMetaData.h"

class ZTFirmwarePlugin : public FirmwarePlugin
{
    Q_OBJECT

public:
    ZTFirmwarePlugin(void);
    ...
    QString             internalParameterMetaDataFile   (Vehicle* vehicle) override { Q_UNUSED(vehicle); return QString(":/FirmwarePlugin/ZT/ZTParameterFactMetaData.xml"); }
    void                getParameterMetaDataVersionInfo (const QString& metaDataFile, int& majorVersion, int& minorVersion) override { ZTParameterMetaData::getParameterMetaDataVersionInfo(metaDataFile, majorVersion, minorVersion); }
    QObject*            loadParameterMetaData           (const QString& metaDataFile) final;
    bool                adjustIncomingMavlinkMessage    (Vehicle* vehicle, mavlink_message_t* message) override;
    QString             offlineEditingParamFile(Vehicle* vehicle) override { Q_UNUSED(vehicle); return QStringLiteral(":/FirmwarePlugin/ZT/ZT.OfflineEditing.params"); }
    QString             brandImageIndoor                (const Vehicle* vehicle) const override { Q_UNUSED(vehicle); return QStringLiteral("/qmlimages/ZT/BrandImage"); }
    QString             brandImageOutdoor               (const Vehicle* vehicle) const override { Q_UNUSED(vehicle); return QStringLiteral("/qmlimages/ZT/BrandImage"); }
...
private:
    ...
    // Vehicle specific data should go into ZTFirmwarePluginInstanceData
};

class ZTFirmwarePluginInstanceData : public QObject
{
    Q_OBJECT

public:
    ZTFirmwarePluginInstanceData(QObject* parent = NULL);
